...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/epicscorelibs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/epicscorelibs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7526&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epicscorelibs-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.15.____cp315" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add epicscorelibs
# for installing globally
pixi global install epicscorelibs
```
...
It is possible to list all of the versions of `epicscorelibs` available on your platform:
...
```
pixi search epicscorelibs --channel conda-forge
```
